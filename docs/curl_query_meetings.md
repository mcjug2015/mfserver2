...
# wednesday and friday meetings that start after 7pm within distance from a point
curl -f -k -v "https://127.0.0.1/mfserver2/api/v1/meeting/?lat=39&long=-77&distance=10&day_of_week__in=4&day_of_week__in=6&start_time__gte=19:00"
